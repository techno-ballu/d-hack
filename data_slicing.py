...
combined['Divorce'] = combined['Divorce'].map( {'yes': 1, 'no': 0, None : -99} ).astype(int)

# Widowed - no = 0, yes = 4, missing = 2
combined['Widowed'] = combined['Widowed'].map( {'yes': 1, 'no': 0, None : -99} ).astype(int)
